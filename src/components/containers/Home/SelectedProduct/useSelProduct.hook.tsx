...
import { IProduct, IProductImage, IProductSize } from "../../../../model/IProductType";
import { IRootState } from "../../../../redux/reducer/CombineReducer";
import { dateInPast, getProductDetails, LoggedInProf, LoggedInUser, updateLocalCart } from "../../../common/Script";
import { SelectedProductSlice } from "../../../stateContainers/SelectedProduct/Slice";
import { ISelectedProduct, ModalEnum } from "../../../stateContainers/SelectedProduct/Types";
...
export const useSelProduct = () => {
  ...
  const FavIconOnclick = (e: onClick) => {
    ...
    if (LoggedInUser || LoggedInProf !== null) {
